    ...
    <header className="flex items-center justify-between mb-8">
      ...
      <div className="flex items-center gap-3 px-4 py-2 bg-surface border border-white/10 rounded-full">
        <div className="relative flex h-3 w-3">
          ...
          <span className={`relative inline-flex rounded-full h-3 w-3 ${socketConnected ? 'bg-[#10B981] shadow-[0_0_10px_rgba(16,185,129,0.8)]' : 'bg-[#EF4444] shadow-[0_0_10px_rgba(239,68,68,0.5)]'}`}></span>
        </div>
        <span className={`text-[10px] uppercase tracking-widest font-black ${socketConnected ? 'text-[#10B981]' : 'text-[#EF4444]'}`}>
