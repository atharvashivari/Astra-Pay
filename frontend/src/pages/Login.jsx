  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-5xl font-black text-gray-900 uppercase tracking-tighter">
          Astra-Pay
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Sign in to your wallet or{' '}
          <Link to="/register" className="font-bold text-black border-b-2 border-black hover:text-gray-700">
            register here
          </Link>
        </p>
      </div>
